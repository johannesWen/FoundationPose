...
# source : https://medium.com/@simonyihunie/installing-intel-realsense-d435i-camera-on-nvidia-jetson-orin-nx-step-by-step-guide-2ef420483064
...
cmake ../ -DFORCE_LIBUVC=true -DCMAKE_BUILD_TYPE=release -DBUILD_PYTHON_BINDINGS:bool=true -DBUILD_WITH_CUDA=true
make -j2
make install
